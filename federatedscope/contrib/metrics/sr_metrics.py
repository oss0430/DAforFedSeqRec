...
def load_ndcg_10(ctx : Context, y_true : np.ndarray, y_pred : np.ndarray, y_prob, **kwargs):
    """
    Load ndcg@10 metric.
    """
...
def load_ndcg_20(ctx : Context, y_true : np.ndarray, y_pred : np.ndarray, y_prob, **kwargs):
    """
    Load ndcg@20 metric.
    """
